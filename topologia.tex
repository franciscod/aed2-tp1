\begin{tadx}{\tadNombre{Topología}}{
	...
	\tadOperacion{conectados?}{topologia/t, nat/ipA, nat/ipB}{bool}{$ipA \in compus(t) $ $\land$ $ipB \in compus(t)$}
        ...
        \tadOperacion{darSegmento}{topologia/t, nat/ipA, nat/ipB}{segmento}{$ipA \in compus(t)$ $\land$ $ipB \in vecinas(t, ipA)$}
	...
	\tadOperacion{darRutas}{topologia, nat, nat, conj(nat), {secu(segmento))}}{conj(secu(segmento)))}{}
	\tadOperacion{darRutasVecinas}{topologia, conj(nat), nat, conj(nat), secu(segmento)}{conj(secu(segmento))}{}
