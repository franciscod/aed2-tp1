\begin{tadx}{\tadNombre{Topología}}{
	...
	\tadOperacion{conectados?}{topologia/t, nat/ipA, nat/ipB}{bool}{$ipA \in compus(t) $ $\land$ $ipB \in compus(t)$}
        \tadOperacion{darInterfazConectada}{topologia/t, {conj(tupla(nat, nat))}/cablesA, nat/ipB}{nat}{$ipB \in \pi_2Conj(cablesA)$}
	\tadOperacion{darCaminoMasCorto}{topologia/t, nat/ipA, nat/ipB}{secu(nat)}{$ipA \in compus(t)$ $\land$ $ipB \in compus(t)$ $\yluego conectados?(t, ipA, ipB)$}
	\tadOperacion{darRutas}{topologia, nat, nat, conj(nat), secu(nat)}{conj(secu(tupla(nat, nat)))}{}
	\tadOperacion{darRutasVecinas}{topologia, conj(nat), nat, conj(nat), secu(nat)}{conj(secu(tupla(nat, nat))}{}
	...
	\tadAxioma{conectados?($t$, $ipA$, $ipB$)}{
        ...
        \tadAxioma{darInterfazConectada($t$, $conjDuplas$, $ipB$)}{
            \IF $ipB$ = $\pi_2$(dameUno($conjDuplas$)) THEN $\pi_1$(dameUno($conjDuplas$)) ELSE darInterfazConectada($t$, sinUno($conjDuplas$), $ipB$) FI
        }
