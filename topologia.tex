\begin{tadx}{\tadNombre{Topología}}{
	...
	\tadOperacion{conectados?}{topologia/t, pc/ipA, pc/ipB}{bool}{$ipA \in compus(t) $ $\land$ $ipB \in compus(t)$}
	\tadOperacion{darInterfazConectada}{{conj(tupla(pc, nat))}/cablesA, pc/ipB}{nat}{$ipB \in \pi_2Conj(cablesA)$}
	...
	\tadOperacion{darCaminoMasCorto}{topologia/t, pc/ipA, pc/ipB}{secu(segmento)}{$ipA \in compus(t)$ $\land$ $ipB \in compus(t)$ $\yluego conectados?(t, ipA, ipB)$}
	...
	\paratodo{conj(tupla(pc, nat))}{conjDuplas},
	\paratodo{conj(tupla(pc, nat))}{conjCablesIpA},
	\paratodo{conj(pc)}{rec, vecinas},
