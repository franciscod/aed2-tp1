...
\par \textbf{TAD} pc \textbf{ES} nat
\par \textbf{TAD} paquete \textbf{ES} tupla(nat id, nat ipOrigen, nat ipDestino, nat prioridad)
\par \textbf{TAD} segmento \textbf{ES} tupla(nat ipOrigen, nat interfazOrigen, nat ipDestino, nat interfazDestino)
