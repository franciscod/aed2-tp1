...
\par \textbf{TAD} pc, id, ipOrigen, ipDestino, prioridad, interfazOrigen, interfazDestino \textbf{ES} nat
\par \textbf{TAD} paquete \textbf{ES} tupla(id, ipOrigen, ipDestino, prioridad)
\par \textbf{TAD} segmento \textbf{ES} tupla(ipOrigen, interfazOrigen, ipDestino, interfazDestino)
