\begin{tad}{\tadNombre{DCNet}}
	...
	\tadAxioma{cronoPaquetes(paquetePendiente(dcn,o,d,p),bs)}{ $auxDefinir(bs,o,Ag(p,\emptyset),obtener(o,bs))$ 
	...
	\tadAxioma{envioYReciboPaquetes(t,bs,cp)}{\IF $\emptyset?(cp)$ THEN $bs$ ELSE $ envioYReciboPaquetes(t,envio(t,bs,dameUno(cp)),$
													$sinUno(cp))$ FI}
