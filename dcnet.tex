\begin{tad}{\tadNombre{DCNet}}
	...
	\tadOperacion{buscarPrioridad}{nat,conj(paquetes)/cp}{nat}{$\neg \emptyset$?(cp)}
	\tadOperacion{maxPrioridad}{dcnet,conj(pc) c}{nat}{$\neg \emptyset$?(cc)}
	\tadOperacion{PaquetesConPrioridadK}{dcnet,conj(pc),nat}{conj(paquete)}{ k > 0 $\land$ $\neg \emptyset$?(cc)}


	\tadOperacion{paquetesEnLaRed}{dcnet dcn}{conj(paquete)}{$\neg \emptyset$?(compus(topo(dcn)))}
	\tadOperacion{buscarPaquetesEnLaRed}{dcnet, conj(pc))}{conj(paquete)}{}

	\tadOperacion{compuQueMasEnvio}{dcnet dcn}{pc}{$\neg \emptyset$?(compus(topo(dcn)))}
	\tadOperacion{maxEnviado}{dcnet,conj(pc) cc }{nat}{$\neg \emptyset$?(cc)}
